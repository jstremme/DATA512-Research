...
- The model achieves 0.322 PR AUC vs 0.387 because we have eliminated some of the less important features which explained some of the variance but not the majority
